...
public final class IncrementalSyncContractTest {
    ...
    public static void main(String[] args) {
        ...
        ok(SyncBatchPolicy.hasMore(2, 0), "100k + 2 delta must remain queued until both are handled");
        ok(!SyncBatchPolicy.hasMore(0, 0), "empty queue must finish");
        // Key invariant: batch size is constant; it never scales to 100,000 based on library size.
